...
@interface BlackKeyboardSettingsController : PSTableCell {
    UILabel *heading;
    UILabel *subtitle;
    UIImageView *imgView;
}
...
@implementation BlackKeyboardSettingsController
...
- (id)initWithSpecifier:(PSSpecifier *)specifier {
    ...
    if (self) {
       ...
       self.backgroundColor = [UIColor clearColor];
        ...
        heading.font = [UIFont fontWithName:@"HelveticaNeue-UltraLight" size:60];
        [heading setText:@"Black Keyboard"]; //Change this to whatever you want..
        ...
        [subtitle setText:@""];  //Change this to whatever you want..
